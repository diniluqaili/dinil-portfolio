...
export const translations: Record<Language, Translation> = {
  ...
  categories: [
    ...
    { name: 'IoT',      items: ['ESP32', 'Raspberry Pi', 'MQTT', 'PID Control', 'Sensor Arrays'] },
  ...
  categories: [
    ...
    { name: 'IoT',        items: ['ESP32', 'Raspberry Pi', 'MQTT', 'Kontrol PID', 'Array Sensor'] },
