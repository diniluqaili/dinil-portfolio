    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div className="contact-links">
          <a
            href="mailto:diniluqaili@gmail.com"
            style={{
              flex: 1,
              display: "flex",
          ...
          >
            ...
            diniluqaili@gmail.com
          </a>

          <a
            href="https://github.com/diniluqaili"
            target="_blank"
            rel="noreferrer"
            style={{
              flex: 1,
          ...
          <a
            href="www.linkedin.com/in/m-syarafuddinil-uqaili-6aa33b261"
            target="_blank"
            rel="noreferrer"
            style={{
              flex: 1,
